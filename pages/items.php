...
data = data + "&item_company" + rowdata.co_id;
                    $.ajax( {
                        dataType: 'json',
                        url: 'items-controller.php',
                        type: 'GET',
   ...
   {           
      ...
      $("#popupadd").jqxWindow({
        ...
        var generaterow = function (id) {//adding new row for new data entry
                ...
                row["item_image"] =$("#imageupload").val();
...
$("#Update").click(function () {
        ...
        if (editrow >= 0) {
         ...
         var row = {i_name: $("#itemname").val(), i_serial: $("#itemserial").val(), i_model: $("#itemmodel").val(), i_qty: $("#itemqty").val(), 
         i_price: $("#itemprice").val(),i_dob: $("#birthInput1").val(),ee_id: $("#itememployee").val(),co_id: $("#itemcompany").val(),i_id: $("#itemid").val()};                   
            ...
            <div style="overflow: hidden;">
              <table>
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="file" name="item_image" ></div></td>
